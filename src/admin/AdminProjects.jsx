...
import { PageHeader, StatCard, StatusPill, PrimaryButton, DarkButton, OutlineButton, Field, inputStyle, Card } from "./adminUI";
...
export default function AdminProjects() {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: editorOpen ? "minmax(0,1fr) 380px" : "1fr", gap: 24 }}>
        ...
        {editorOpen && (
          <Card>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 20 }}>
              <div style={{ fontWeight: 500 }}>{editingId ? "Modifier le projet" : "Nouveau projet"}</div>
              <button onClick={() => setEditorOpen(false)} style={{ background: "none", border: "none", cursor: "pointer", color: COLORS.text3 }}>
                Fermer
              </button>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <OutlineButton onClick={() => save("Brouillon")}>Brouillon</OutlineButton>
              </div>
            </div>
          </Card>
        )}
